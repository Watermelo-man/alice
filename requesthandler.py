...
class datarequest():
    ...
    def __init__(self) -> None:
        ...
        self.accepted = ["да", "ага", "угу", "хорошо", "давай", "рассажи", "хочу",
        ...
        self.rejected = ["нет", "net", "неа", "не-а", "не надо", "не хочу", "не хотим", "не играл",
    ...
    def help_f(self):
        ...
        if baseinstance.connect():
            ...
            self.session_store['buttons'] = [ { "title": "Назад", "payload": self.session_store['flags']['return_state'], "hide": True } ]

...
print(compare_texts('А что скажешь про карточку глубоководные','как работает карта глубоководные'))

print(compare_texts('расскажи что делает карта дагон','как работает карта глубоководные'))
